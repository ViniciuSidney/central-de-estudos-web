...
export function initResetData() {
	...
	if (!openResetButton || !resetModal || !firstConfirmInput || !finalGroup || !finalInput || !resetMessage || !cancelResetButton || !confirmResetButton) {
		return;
	}
	...
	function resetAllData() {
		...
		document.dispatchEvent(new CustomEvent('app:data-reset'));
