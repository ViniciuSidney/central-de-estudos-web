...
export function initNotes() {
	...
	const noteFilterSubjectSelect = document.querySelector('#note-filter-subject');
	...
	function renderNotes() {
      ...
      `;
		...
		notes.forEach((note) => {
			...
			const subjectName = note.subjectId ? getSubjectNameById(note.subjectId) : 'Livre';

			const themeName = note.themeId ? getThemeNameById(note.themeId) : 'Sem tema';
