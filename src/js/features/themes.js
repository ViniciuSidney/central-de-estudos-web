...
export function initThemes() {
	...
	function setSubtopicImportSummary({title = 'Aguardando validação.', description = 'Selecione uma matéria, um tema, cole a lista e clique em Validar assuntos.', type = 'default'} = {}) {
